...
const MatchRequest = (props) => {
  ...
  return (
    <div className='flex flex-col items-center bg-white p-8 rounded text-center shadow-xl'>
      <img src="https://i.ibb.co/4WTkXk5/Asset-1.png" alt="card-image" className="h-20 w-20 -mt-16 mb-2" />
      ...
      <p className='mb-4 text-sm font-bold'>{props.group ? "Send forespørsel om medlemskap" : "Ønsker du å invitere til gruppen?"}</p>
